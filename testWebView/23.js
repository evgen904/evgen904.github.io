/**
 * MODULE: messages FILE: response_comment.js
 */
$(function() {
	var responseForm = {
		s: {
...
/**
 * MODULE: messages FILE: reviews-slider.js
 */
$(function(){
    $('.reviews-slider-js')
        .owlCarousel(wp.reviewsSlider.owl)
        .lightGallery(wp.lightGallery.options('.reviews-slider-js .owl-item:not(".cloned") .item', 0))
        .on('onAfterOpen.lg',function(event){
            $('.lg-sub-html').after($('#lg-counter'));
        });
});

/**
 * MODULE: default FILE: lightgallery-slider/jquery.mousewheel.min.js
 */
...
/**
 * MODULE: default FILE: lightgallery-slider/lightgallery.min.slider.js
 */
...
/**
 * MODULE: default FILE: lightgallery-slider/lightgallery.slider.modified.js
 */
// lightGallery доработка видео под тег stream, и загрузка превью фото если используется lazyLoad в owlCarousel
...
/**
 * MODULE: default FILE: lightgallery-slider/lightGallery.options.js
 */
wp.createNS('lightGallery');
wp.lightGallery.options = function(selector, video){
    var thumbnailVal = (screen.width>960) ? true : false;
    var controlsVal = (screen.width>960) ? true : false;
    var zoomVal = (screen.width>960) ? false : true;
    var speedVal = (screen.width>960) ? 600 : 250;
    var enableSwipeVal = (screen.width>960 || video !== 1) ? true : false;
    var counterVal = (screen.width>960 || video !== 1) ? true : false;
    return {
        selector: selector,
        thumbWidth:120,
        thumbMargin: 3,
        ...
        speed: speedVal,
        counter: counterVal,
        enableSwipe: enableSwipeVal       
    }
};

/**
 * MODULE: default FILE: owl.carousel/owl.carousel.min.js
 */
/**
 * Owl Carousel v2.3.4
...
/**
 * MODULE: default FILE: owl.carousel/owl.reviews.js
 */
wp.createNS('reviewsSlider');
wp.reviewsSlider.owl = (function(){
    return {
        margin: 2,
        items: 4,
        lazyLoad:true,
